...
/**
 * Created by mohamed salah on 03/10/2016.
 */
...
public final class Links {
    ...
    final static String ProfilePictures="http://www.e-transport.eu/uploads/ProfilesPictures/";
    public static String getProfilePictures() {
